...
public class ClienteService {
    ...
    public Cliente actualizar(Integer id, Cliente cliente) throws Exception {
        ...
        if (cliente.getNombreComercial() != null) {
            existente.setNombreComercial(cliente.getNombreComercial());
        }
        ...
        if (cliente.getPais() != null) {
            existente.setPais(cliente.getPais());
        }
        if (cliente.getDiasCredito() != null) {
            existente.setDiasCredito(cliente.getDiasCredito());
        }
        if (cliente.getLimiteCredito() != null) {
            existente.setLimiteCredito(cliente.getLimiteCredito());
        }
        if (cliente.getDescuentoGeneral() != null) {
            existente.setDescuentoGeneral(cliente.getDescuentoGeneral());
        }
