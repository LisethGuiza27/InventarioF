...
/**
 * Modelo para gestionar ubicaciones específicas dentro de almacenes Permite
 * trazabilidad y organización física del inventario
 */
@Entity
...
public class Ubicacion {
    ...
    public Boolean getPermiteMixto() {
        return permiteMixto;
    }

    public void setPermiteMixto(Boolean permiteMixto) {
        this.permiteMixto = permiteMixto;
    }
