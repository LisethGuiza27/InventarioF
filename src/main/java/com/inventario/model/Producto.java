...
public class Producto {
    ...
    public Boolean getEsPerecedero() { return esPerecedero; }
    ...
    public Boolean getRequiereSerie() { return requiereSerie; }
    ...
    public Boolean getTieneImpuestos() { return tieneImpuestos; }
    public void setTieneImpuestos(Boolean tieneImpuestos) { this.tieneImpuestos = tieneImpuestos; }
    ...
    public Double getCostoAlmacenamiento() { return costoAlmacenamiento; }
    public void setCostoAlmacenamiento(Double costoAlmacenamiento) { this.costoAlmacenamiento = costoAlmacenamiento; }
